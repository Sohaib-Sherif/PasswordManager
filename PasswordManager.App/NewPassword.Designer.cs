namespace PasswordManager.App
{
    partial class NewPassword
    {
        ...
        private void InitializeComponent()
        {
			...
			this.txtWebsite.TextChanged += new System.EventHandler(this.txtName_TextChanged);
			// 
			// txtUsername
			// 
			...
			this.rtxtNotes.Text = "";
			this.rtxtNotes.TextChanged += new System.EventHandler(this.txtName_TextChanged);
			// 
			// btnOptions
			// 
